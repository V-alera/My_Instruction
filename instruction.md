...
* Команда *git shortlog* - служит для подведения итогов команды git log, принимает практически те же параметры, что и git log, но вместо простого списка всех коммитов, они будут сгруппированы по автору
